...
const FormFields: React.FC<FormFieldsProps> = ({
  ...
  return (
    <Card className="p-4">
      {/* Horizontal Row Layout for Fields */}
      <div className="flex flex-col md:flex-row gap-4 items-start">
        {/* Hours Field - Smallest width */}
        <div className="w-full md:w-24 flex-shrink-0 space-y-2">
        ...
        <div className="w-full md:w-36 flex-shrink-0 space-y-2">
        ...
        {/* Description Field - Flexible width (takes remaining space) */}
        <div className="w-full md:flex-1 space-y-2">
          ...
          <Textarea
            ...
            className={cn(descriptionError ? 'border-destructive' : '', "min-h-[38px] resize-y")}
            disabled={disabled}
