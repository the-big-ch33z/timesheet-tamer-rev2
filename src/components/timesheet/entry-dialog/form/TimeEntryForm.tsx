...
const TimeEntryForm: React.FC<TimeEntryFormProps> = ({
  ...
  const { formState, setFieldValue, validateForm, resetForm } = useFormState('time-entry', {
          ...
          {showTimeInputs && (
            <div className="flex flex-col md:flex-row gap-4">
              <div className="w-full md:w-1/2">
                ...
                <Input
                  type="time"
                  value={formState.fields.startTime.value}
              ...
              <div className="w-full md:w-1/2">
                ...
                <Input
                  type="time"
                  value={formState.fields.endTime.value}
