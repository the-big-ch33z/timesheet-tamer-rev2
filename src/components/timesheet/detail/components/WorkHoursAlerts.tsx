...
const WorkHoursAlerts: React.FC<WorkHoursAlertsProps> = ({
  ...
  if (isUndertime && isPast && !isComplete) {
    return <div className="mt-2 p-2 rounded-md bg-amber-50 border border-amber-100 text-amber-700 flex items-center text-xs">
  ...
  if (isToday && !isComplete) {
    return <div className="mt-2 p-2 rounded-md bg-blue-50 border border-blue-100 text-blue-700 flex items-center text-xs">
