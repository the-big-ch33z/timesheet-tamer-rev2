      ...
      {isWorkDay && <>
          ...
          <div className="flex items-center gap-4 ml-4">
            <ToggleGroup type="multiple" variant="outline" size="sm">
              <ToggleGroupItem value="lunch" aria-label="Toggle lunch break" data-state={breaks.lunch ? "on" : "off"} onClick={() => toggleBreak(day, 'lunch')} className="rounded-sm bg-green-200 hover:bg-green-100">
